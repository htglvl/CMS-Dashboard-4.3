...
for k in range(1, n_folds):
    ...
    rf_f1w = f1_score(y_val, rf_pred, labels=RISK_LABELS, average="weighted", zero_division=0)
    ...
    rf_metrics.append({"accuracy": rf_acc, "f1_macro": rf_f1, "f1_weighted": rf_f1w, "precision": rf_prec, "recall": rf_rec})
    ...
    xgb_f1w = f1_score(y_val, xgb_pred, labels=RISK_LABELS, average="weighted", zero_division=0)
